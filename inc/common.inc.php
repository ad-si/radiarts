...
<head>
    ...
    <meta name="description"
          content="You can use radiobuttons for much more than just a formular!"/>
    <meta name="keywords"
          content="radiarts, radiobutton, radiobuttons, radiart, radiobutton art, radiartwork, radiartworks"/>
...
<div id="content" onclick="hide_slider();">
    ...
    <br/>
    <a href="paint.php">
        <img src="img/arrow.png" title="Create"
             alt="Create your own radiartwork"/>
        <br/>Create your own radiartwork
    </a>
    <br/>
    <a href="database.php">
        <img src="img/glass.png" title="Browse through all of the radiartworks"
             alt="Browse through all of the radiartworks"/>
        <br/>Browse through all of the radiartworks
    </a>
    <br/>
